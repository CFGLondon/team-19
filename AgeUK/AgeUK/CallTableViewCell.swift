...
class CallTableViewCell: UITableViewCell {
  ...
  override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
    ...
    let image = UIImageView(image: UIImage(named: "accessory76"))
//    image.backgroundColor = UIColor.lightGrayColor()
    ...
    button = UIButton()
    button.setTitle("CALL NOW", forState: UIControlState.Normal)
    ...
    let a = UILabel()
    a.text = "*available today till 6pm"
    a.font = UIFont.boldSystemFontOfSize(11)
    a.alpha = 0.5
    self.addSubview(a)
