...
class AgreeViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    self.navigationItem.leftBarButtonItem = UIBarButtonItem(title: "Decline",
      style: UIBarButtonItemStyle.Plain, target: self, action: "next")
    self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "I agree",
      style: UIBarButtonItemStyle.Plain, target: self, action: "next")
    ...
    let image = UIImageView(image: UIImage(named: "agree"))
